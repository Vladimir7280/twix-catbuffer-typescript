...
/**
 * Interface to create instances of MultisigAccountModificationTransactionV1
 */
...
This transaction allows you to: - Transform a regular account into a multisig account. - Change the configurable properties of a multisig account. - Add or delete cosignatories from a multisig account (removing all cosignatories turns a multisig account into a regular account
 * again).
 */
export class MultisigAccountModificationTransactionV1 implements Serializer {
    /**
     * TRANSACTION_VERSION
     */
...
All accounts in this list will stop being able to cosign transactions on behalf of the multisig account. A transaction containing **any** address in this array requires a number of cosignatures at least equal to the minimum removal
    ...
    constructor({
        ...
        addressAdditions,
        addressDeletions,
    }: MultisigAccountModificationTransactionV1Params) {
    ...
    /**
     * Creates an instance of MultisigAccountModificationTransactionV1 from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of MultisigAccountModificationTransactionV1 from binary payload
     */
    public static deserialize(payload: Uint8Array): MultisigAccountModificationTransactionV1 {
