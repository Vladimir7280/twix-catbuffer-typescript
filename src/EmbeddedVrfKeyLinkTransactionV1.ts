...
/**
 * Interface to create instances of EmbeddedVrfKeyLinkTransactionV1
 */
 ...
 */
export class EmbeddedVrfKeyLinkTransactionV1 implements Serializer {
    /**
     * TRANSACTION_VERSION
     */
     ...
     * TRANSACTION_TYPE
     */
    public readonly TRANSACTION_TYPE = 16963;
    /**
     * Public key of the signer of the entity.
     */
    ...
    /**
     * Creates an instance of EmbeddedVrfKeyLinkTransactionV1 from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of EmbeddedVrfKeyLinkTransactionV1 from binary payload
     */
    public static deserialize(payload: Uint8Array): EmbeddedVrfKeyLinkTransactionV1 {
