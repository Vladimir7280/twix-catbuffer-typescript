...
/**
 * Interface to create instances of AggregateBondedTransactionV2
 */
...
To prevent spam attacks, before trying to announce this transaction a HashLockTransaction must be successfully announced and
 * confirmed.
 */
export class AggregateBondedTransactionV2 implements Serializer {
    /**
     * TRANSACTION_VERSION
     */
    public readonly TRANSACTION_VERSION = 2;
    /**
     * TRANSACTION_TYPE
     */
    public readonly TRANSACTION_TYPE = 16961;
    /**
     * Entity's signature generated by the signing account.
     */
...
Fills up remaining body space after transactions.
    ...
    constructor({
        ...
        transactions,
        cosignatures,
    }: AggregateBondedTransactionV2Params) {
    ...
    /**
     * Creates an instance of AggregateBondedTransactionV2 from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of AggregateBondedTransactionV2 from binary payload
     */
    public static deserialize(payload: Uint8Array): AggregateBondedTransactionV2 {
