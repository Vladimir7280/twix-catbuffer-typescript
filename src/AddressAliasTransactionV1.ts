...
/**
 * Interface to create instances of AddressAliasTransactionV1
 */
...
A namespace can be assigned to any account present in the network (this is, an account which has received at least one
 * transaction).
 */
export class AddressAliasTransactionV1 implements Serializer {
    /**
     * TRANSACTION_VERSION
     */
    ...
    constructor({
        ...
        address,
        aliasAction,
    }: AddressAliasTransactionV1Params) {
    ...
    /**
     * Creates an instance of AddressAliasTransactionV1 from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of AddressAliasTransactionV1 from binary payload
     */
    public static deserialize(payload: Uint8Array): AddressAliasTransactionV1 {
