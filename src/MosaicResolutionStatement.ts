...
/**
 * Interface to create instances of MosaicResolutionStatement
 */
 ...
 */
export class MosaicResolutionStatement implements Serializer {
    /**
     * Unresolved mosaic.
     */
    public readonly unresolved: UnresolvedMosaicId;
    /**
     * Resolution entries.
     */
    public readonly resolutionEntries: MosaicResolutionEntry[];
    ...
    /**
     * Creates an instance of MosaicResolutionStatement from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of MosaicResolutionStatement from binary payload
     */
    public static deserialize(payload: Uint8Array): MosaicResolutionStatement {
        const byteArray = Array.from(payload);
        const unresolved = UnresolvedMosaicId.deserialize(Uint8Array.from(byteArray));
        byteArray.splice(0, unresolved.size);
        const resolutionEntriesCount = Utils.bufferToUint32(Uint8Array.from(byteArray));
        byteArray.splice(0, 4);
        const resolutionEntries = Utils.deserialize(MosaicResolutionEntry.deserialize, Uint8Array.from(byteArray), resolutionEntriesCount);
