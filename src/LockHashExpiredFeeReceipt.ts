...
/**
 * Interface to create instances of LockHashExpiredFeeReceipt
 */
 ...
 */
export class LockHashExpiredFeeReceipt implements Serializer {
    /**
     * RECEIPT_TYPE
     */
    public readonly RECEIPT_TYPE = 9032;
    /**
     * Receipt version.
     */
    ...
    /**
     * Creates an instance of LockHashExpiredFeeReceipt from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of LockHashExpiredFeeReceipt from binary payload
     */
    public static deserialize(payload: Uint8Array): LockHashExpiredFeeReceipt {
        ...
        return new LockHashExpiredFeeReceipt({ version: version, type: type, mosaic: mosaic, targetAddress: targetAddress });
    }
