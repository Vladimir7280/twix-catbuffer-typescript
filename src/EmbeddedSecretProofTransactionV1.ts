...
/**
 * Interface to create instances of EmbeddedSecretProofTransactionV1
 */
 ...
 */
export class EmbeddedSecretProofTransactionV1 implements Serializer {
    /**
     * TRANSACTION_VERSION
     */
    ...
    constructor({
        ...
        hashAlgorithm,
        proof,
    }: EmbeddedSecretProofTransactionV1Params) {
    ...
    /**
     * Creates an instance of EmbeddedSecretProofTransactionV1 from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of EmbeddedSecretProofTransactionV1 from binary payload
     */
    public static deserialize(payload: Uint8Array): EmbeddedSecretProofTransactionV1 {
