...
/**
 * Interface to create instances of EmbeddedAccountAddressRestrictionTransactionV1
 */
 ...
 */
export class EmbeddedAccountAddressRestrictionTransactionV1 implements Serializer {
    /**
     * TRANSACTION_VERSION
     */
    ...
    }: EmbeddedAccountAddressRestrictionTransactionV1Params) {
    ...
    /**
     * Creates an instance of EmbeddedAccountAddressRestrictionTransactionV1 from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of EmbeddedAccountAddressRestrictionTransactionV1 from binary payload
     */
    public static deserialize(payload: Uint8Array): EmbeddedAccountAddressRestrictionTransactionV1 {
