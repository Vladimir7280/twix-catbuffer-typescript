...
/**
 * Interface to create instances of ImportanceBlock
 */
export interface ImportanceBlockParams {
    /**
 ...
 */
export class ImportanceBlock implements Serializer {
    /**
     * BLOCK_VERSION
     */
     ...
     * BLOCK_TYPE
     */
    public readonly BLOCK_TYPE = 33347;
    /**
     * Entity's signature generated by the signing account.
     */
     ...
     * total balance eligible for voting
     */
    public readonly totalVotingBalance: Amount;
    /**
     * previous importance block hash
     */
    public readonly previousImportanceBlockHash: Hash256;
    /**
     * variable sized transaction data
     */
    ...
    /**
     * Creates an instance of ImportanceBlock from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of ImportanceBlock from binary payload
     */
    public static deserialize(payload: Uint8Array): ImportanceBlock {
        ...
        const votingEligibleAccountsCount = Utils.bufferToUint32(Uint8Array.from(byteArray));
        byteArray.splice(0, 4);
        const harvestingEligibleAccountsCount = Utils.bufferToBigInt(Uint8Array.from(byteArray));
        byteArray.splice(0, 8);
        const totalVotingBalance = Amount.deserialize(Uint8Array.from(byteArray));
        byteArray.splice(0, totalVotingBalance.size);
        const previousImportanceBlockHash = Hash256.deserialize(Uint8Array.from(byteArray));
    ...
    public serialize(): Uint8Array {
        ...
        const votingEligibleAccountsCountBytes = Utils.uint32ToBuffer(this.votingEligibleAccountsCount);
        newArray = Utils.concatTypedArrays(newArray, votingEligibleAccountsCountBytes);
        const harvestingEligibleAccountsCountBytes = Utils.bigIntToBuffer(this.harvestingEligibleAccountsCount);
        newArray = Utils.concatTypedArrays(newArray, harvestingEligibleAccountsCountBytes);
        const totalVotingBalanceBytes = this.totalVotingBalance.serialize();
        newArray = Utils.concatTypedArrays(newArray, totalVotingBalanceBytes);
        const previousImportanceBlockHashBytes = this.previousImportanceBlockHash.serialize();
        newArray = Utils.concatTypedArrays(newArray, previousImportanceBlockHashBytes);
