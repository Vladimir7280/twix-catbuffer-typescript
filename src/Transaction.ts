...
/**
 * Interface to create instances of Transaction
 */
...
export class Transaction implements Serializer {
    ...
    /**
     * Creates an instance of Transaction from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of Transaction from binary payload
     */
