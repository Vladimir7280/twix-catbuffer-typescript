...
/**
 * Interface to create instances of LockSecretExpiredFeeReceipt
 */
 ...
 */
export class LockSecretExpiredFeeReceipt implements Serializer {
    /**
     * RECEIPT_TYPE
     */
    public readonly RECEIPT_TYPE = 9042;
    /**
     * Receipt version.
     */
    ...
    /**
     * Creates an instance of LockSecretExpiredFeeReceipt from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of LockSecretExpiredFeeReceipt from binary payload
     */
    public static deserialize(payload: Uint8Array): LockSecretExpiredFeeReceipt {
        ...
        return new LockSecretExpiredFeeReceipt({ version: version, type: type, mosaic: mosaic, targetAddress: targetAddress });
    }
