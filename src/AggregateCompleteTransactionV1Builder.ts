...
**/
export class AggregateCompleteTransactionV1Builder extends TransactionBuilder implements Serializer {
...
Fills up remaining body space after transactions..
    */
    ...
    public static loadFromBinary(payload: Uint8Array): AggregateCompleteTransactionV1Builder {
        ...
        return new AggregateCompleteTransactionV1Builder(
    ...
    /**
     * Creates an instance of AggregateCompleteTransactionV1Builder.
     *
     * @param signature Entity's signature generated by the signing account..
     * @param signerPublicKey Public key of the signer of the entity..
     * @param version Version of this structure..
...
Embedded transactions cannot be aggregates..
     * @param cosignatures Cosignatures data.
Fills up remaining body space after transactions..
     * @return Instance of AggregateCompleteTransactionV1Builder.
     */
    public static createAggregateCompleteTransactionV1Builder(
        signature: SignatureDto,
        signerPublicKey: PublicKeyDto,
        version: number,
        network: NetworkTypeDto,
        ...
        transactions: EmbeddedTransactionBuilder[],
        cosignatures: CosignatureBuilder[],
    ): AggregateCompleteTransactionV1Builder {
        return new AggregateCompleteTransactionV1Builder(
            signature,
            signerPublicKey,
            version,
