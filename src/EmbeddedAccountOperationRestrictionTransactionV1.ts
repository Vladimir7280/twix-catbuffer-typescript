...
/**
 * Interface to create instances of EmbeddedAccountOperationRestrictionTransactionV1
 */
 ...
 */
export class EmbeddedAccountOperationRestrictionTransactionV1 implements Serializer {
    /**
     * TRANSACTION_VERSION
     */
     ...
     * TRANSACTION_TYPE
     */
    public readonly TRANSACTION_TYPE = 17232;
    /**
     * Public key of the signer of the entity.
     */
    ...
    }: EmbeddedAccountOperationRestrictionTransactionV1Params) {
    ...
    /**
     * Creates an instance of EmbeddedAccountOperationRestrictionTransactionV1 from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of EmbeddedAccountOperationRestrictionTransactionV1 from binary payload
     */
    public static deserialize(payload: Uint8Array): EmbeddedAccountOperationRestrictionTransactionV1 {
        ...
        Utils.bufferToUint32(Uint8Array.from(byteArray));
        byteArray.splice(0, 4);
        const restrictionAdditions = Utils.deserializeEnums(Uint8Array.from(byteArray), restrictionAdditionsCount, 2);
        byteArray.splice(0, restrictionAdditions.reduce((sum) => sum + 2, 0));
        const restrictionDeletions = Utils.deserializeEnums(Uint8Array.from(byteArray), restrictionDeletionsCount, 2);
    ...
    public get size(): number {
        ...
        size += this.restrictionAdditions.reduce((sum) => sum + 2, 0); // restrictionAdditions;
        size += this.restrictionDeletions.reduce((sum) => sum + 2, 0); // restrictionDeletions;
        return size;
    }
    ...
    public serialize(): Uint8Array {
        ...
        const restrictionAdditionsBytes = Utils.writeListEnum(this.restrictionAdditions, 0);
        newArray = Utils.concatTypedArrays(newArray, restrictionAdditionsBytes);
        const restrictionDeletionsBytes = Utils.writeListEnum(this.restrictionDeletions, 0);
