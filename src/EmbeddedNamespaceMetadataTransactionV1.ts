...
/**
 * Interface to create instances of EmbeddedNamespaceMetadataTransactionV1
 */
 ...
 */
export class EmbeddedNamespaceMetadataTransactionV1 implements Serializer {
    /**
     * TRANSACTION_VERSION
     */
     ...
     * TRANSACTION_TYPE
     */
    public readonly TRANSACTION_TYPE = 17220;
    /**
     * Public key of the signer of the entity.
     */
    ...
    constructor({
        ...
        valueSizeDelta,
        value,
    }: EmbeddedNamespaceMetadataTransactionV1Params) {
    ...
    /**
     * Creates an instance of EmbeddedNamespaceMetadataTransactionV1 from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of EmbeddedNamespaceMetadataTransactionV1 from binary payload
     */
    public static deserialize(payload: Uint8Array): EmbeddedNamespaceMetadataTransactionV1 {
        ...
        const targetNamespaceId = NamespaceId.deserialize(Uint8Array.from(byteArray));
    ...
    public serialize(): Uint8Array {
        ...
        newArray = Utils.concatTypedArrays(newArray, targetNamespaceIdBytes);
