...
/**
 * Interface to create instances of LockSecretCompletedFeeReceipt
 */
 ...
 */
export class LockSecretCompletedFeeReceipt implements Serializer {
    /**
     * RECEIPT_TYPE
     */
    public readonly RECEIPT_TYPE = 8786;
    /**
     * Receipt version.
     */
    ...
    /**
     * Creates an instance of LockSecretCompletedFeeReceipt from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of LockSecretCompletedFeeReceipt from binary payload
     */
    public static deserialize(payload: Uint8Array): LockSecretCompletedFeeReceipt {
