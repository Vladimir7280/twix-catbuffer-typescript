...
/**
 * Interface to create instances of EmbeddedTransaction
 */
 ...
 */
export class EmbeddedTransaction implements Serializer {
    /**
     * Public key of the signer of the entity.
     */
    ...
    /**
     * Creates an instance of EmbeddedTransaction from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of EmbeddedTransaction from binary payload
     */
    public static deserialize(payload: Uint8Array): EmbeddedTransaction {
