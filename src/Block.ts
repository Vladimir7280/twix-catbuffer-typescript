...
/**
 * Interface to create instances of Block
 */
 ...
 */
export class Block implements Serializer {
    /**
     * Entity's signature generated by the signing account.
     */
    ...
    /**
     * Creates an instance of Block from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of Block from binary payload
     */
    public static deserialize(payload: Uint8Array): Block {
