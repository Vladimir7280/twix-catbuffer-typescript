...
/**
 * Interface to create instances of MosaicRentalFeeReceipt
 */
 ...
 */
export class MosaicRentalFeeReceipt implements Serializer {
    /**
     * RECEIPT_TYPE
     */
    public readonly RECEIPT_TYPE = 4685;
    /**
     * Receipt version.
     */
    ...
    /**
     * Creates an instance of MosaicRentalFeeReceipt from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of MosaicRentalFeeReceipt from binary payload
     */
    public static deserialize(payload: Uint8Array): MosaicRentalFeeReceipt {
        ...
        return new MosaicRentalFeeReceipt({
            version: version,
            type: type,
            mosaic: mosaic,
