...
/**
 * Interface to create instances of EmbeddedMosaicMetadataTransactionV1
 */
 ...
 */
export class EmbeddedMosaicMetadataTransactionV1 implements Serializer {
    /**
     * TRANSACTION_VERSION
     */
     ...
     * TRANSACTION_TYPE
     */
    public readonly TRANSACTION_TYPE = 16964;
    /**
     * Public key of the signer of the entity.
     */
    ...
    constructor({
        ...
        valueSizeDelta,
        value,
    }: EmbeddedMosaicMetadataTransactionV1Params) {
    ...
    /**
     * Creates an instance of EmbeddedMosaicMetadataTransactionV1 from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of EmbeddedMosaicMetadataTransactionV1 from binary payload
     */
    public static deserialize(payload: Uint8Array): EmbeddedMosaicMetadataTransactionV1 {
        ...
        const targetMosaicId = UnresolvedMosaicId.deserialize(Uint8Array.from(byteArray));
    ...
    public serialize(): Uint8Array {
        ...
        newArray = Utils.concatTypedArrays(newArray, targetMosaicIdBytes);
