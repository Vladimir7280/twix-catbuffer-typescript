...
/**
 * Interface to create instances of NamespaceExpiredReceipt
 */
 ...
 */
export class NamespaceExpiredReceipt implements Serializer {
    /**
     * RECEIPT_TYPE
     */
    public readonly RECEIPT_TYPE = 16718;
    /**
     * Receipt version.
     */
     ...
     * @param artifactId - Expired namespace identifier.
     */
    ...
    /**
     * Creates an instance of NamespaceExpiredReceipt from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of NamespaceExpiredReceipt from binary payload
     */
    public static deserialize(payload: Uint8Array): NamespaceExpiredReceipt {
