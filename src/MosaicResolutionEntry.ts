...
/**
 * Interface to create instances of MosaicResolutionEntry
 */
 ...
 */
export class MosaicResolutionEntry implements Serializer {
    /**
     * Information about the transaction that triggered the receipt.
     */
     ...
     * Resolved MosaicId.
     */
    public readonly resolvedValue: MosaicId;

    /**
     * Constructor
     * @param source - Information about the transaction that triggered the receipt.
     * @param resolvedValue - Resolved MosaicId.
     */
    ...
    /**
     * Creates an instance of MosaicResolutionEntry from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of MosaicResolutionEntry from binary payload
     */
    public static deserialize(payload: Uint8Array): MosaicResolutionEntry {
        const byteArray = Array.from(payload);
        const source = ReceiptSource.deserialize(Uint8Array.from(byteArray));
        byteArray.splice(0, source.size);
        const resolvedValue = MosaicId.deserialize(Uint8Array.from(byteArray));
