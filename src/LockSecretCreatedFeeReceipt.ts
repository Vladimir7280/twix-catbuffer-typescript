...
/**
 * Interface to create instances of LockSecretCreatedFeeReceipt
 */
 ...
 */
export class LockSecretCreatedFeeReceipt implements Serializer {
    /**
     * RECEIPT_TYPE
     */
    public readonly RECEIPT_TYPE = 12626;
    /**
     * Receipt version.
     */
    ...
    /**
     * Creates an instance of LockSecretCreatedFeeReceipt from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of LockSecretCreatedFeeReceipt from binary payload
     */
    public static deserialize(payload: Uint8Array): LockSecretCreatedFeeReceipt {
        ...
        return new LockSecretCreatedFeeReceipt({ version: version, type: type, mosaic: mosaic, targetAddress: targetAddress });
    }
