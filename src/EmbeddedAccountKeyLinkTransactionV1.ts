...
/**
 * Interface to create instances of EmbeddedAccountKeyLinkTransactionV1
 */
 ...
 */
export class EmbeddedAccountKeyLinkTransactionV1 implements Serializer {
    /**
     * TRANSACTION_VERSION
     */
     ...
     * TRANSACTION_TYPE
     */
    public readonly TRANSACTION_TYPE = 16716;
    /**
     * Public key of the signer of the entity.
     */
    ...
    /**
     * Creates an instance of EmbeddedAccountKeyLinkTransactionV1 from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of EmbeddedAccountKeyLinkTransactionV1 from binary payload
     */
    public static deserialize(payload: Uint8Array): EmbeddedAccountKeyLinkTransactionV1 {
