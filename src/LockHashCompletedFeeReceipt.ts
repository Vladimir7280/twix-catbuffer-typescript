...
/**
 * Interface to create instances of LockHashCompletedFeeReceipt
 */
 ...
 */
export class LockHashCompletedFeeReceipt implements Serializer {
    /**
     * RECEIPT_TYPE
     */
    public readonly RECEIPT_TYPE = 8776;
    /**
     * Receipt version.
     */
    ...
    /**
     * Creates an instance of LockHashCompletedFeeReceipt from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of LockHashCompletedFeeReceipt from binary payload
     */
    public static deserialize(payload: Uint8Array): LockHashCompletedFeeReceipt {
        ...
        return new LockHashCompletedFeeReceipt({ version: version, type: type, mosaic: mosaic, targetAddress: targetAddress });
    }
