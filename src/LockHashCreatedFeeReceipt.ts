...
/**
 * Interface to create instances of LockHashCreatedFeeReceipt
 */
 ...
 */
export class LockHashCreatedFeeReceipt implements Serializer {
    /**
     * RECEIPT_TYPE
     */
    public readonly RECEIPT_TYPE = 12616;
    /**
     * Receipt version.
     */
    ...
    /**
     * Creates an instance of LockHashCreatedFeeReceipt from binary payload
     * @param payload - byte payload to use to serialize the object
     * @returns Creates an instance of LockHashCreatedFeeReceipt from binary payload
     */
    public static deserialize(payload: Uint8Array): LockHashCreatedFeeReceipt {
        ...
        return new LockHashCreatedFeeReceipt({ version: version, type: type, mosaic: mosaic, targetAddress: targetAddress });
    }
