...
exports.EmbeddedAccountOperationRestrictionTransactionV1 = void 0;
...
class EmbeddedAccountOperationRestrictionTransactionV1 {
    ...
    static deserialize(payload) {
        ...
        Utils_1.Utils.bufferToUint32(Uint8Array.from(byteArray));
        byteArray.splice(0, 4);
        const restrictionAdditions = Utils_1.Utils.deserializeEnums(Uint8Array.from(byteArray), restrictionAdditionsCount, 2);
        byteArray.splice(0, restrictionAdditions.reduce((sum) => sum + 2, 0));
        const restrictionDeletions = Utils_1.Utils.deserializeEnums(Uint8Array.from(byteArray), restrictionDeletionsCount, 2);
    ...
    serialize() {
        ...
        const restrictionAdditionsBytes = Utils_1.Utils.writeListEnum(this.restrictionAdditions, 0);
        newArray = Utils_1.Utils.concatTypedArrays(newArray, restrictionAdditionsBytes);
        const restrictionDeletionsBytes = Utils_1.Utils.writeListEnum(this.restrictionDeletions, 0);
        newArray = Utils_1.Utils.concatTypedArrays(newArray, restrictionDeletionsBytes);
        return newArray;
    }
}
exports.EmbeddedAccountOperationRestrictionTransactionV1 = EmbeddedAccountOperationRestrictionTransactionV1;
//# sourceMappingURL=EmbeddedAccountOperationRestrictionTransactionV1.js.map