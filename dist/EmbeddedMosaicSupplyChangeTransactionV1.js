...
exports.EmbeddedMosaicSupplyChangeTransactionV1 = void 0;
...
class EmbeddedMosaicSupplyChangeTransactionV1 {
    ...
    static deserialize(payload) {
        ...
        const delta = Amount_1.Amount.deserialize(Uint8Array.from(byteArray));
        byteArray.splice(0, delta.size);
        const action = Utils_1.Utils.bufferToUint8(Uint8Array.from(byteArray));
        byteArray.splice(0, 1);
    ...
    serialize() {
        ...
        newArray = Utils_1.Utils.concatTypedArrays(newArray, deltaBytes);
        const actionBytes = Utils_1.Utils.uint8ToBuffer(this.action);
        newArray = Utils_1.Utils.concatTypedArrays(newArray, actionBytes);
        return newArray;
    }
}
exports.EmbeddedMosaicSupplyChangeTransactionV1 = EmbeddedMosaicSupplyChangeTransactionV1;
//# sourceMappingURL=EmbeddedMosaicSupplyChangeTransactionV1.js.map