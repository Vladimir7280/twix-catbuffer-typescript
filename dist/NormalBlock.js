...
class NormalBlock {
    constructor({ signature, signerPublicKey, version, network, type, height, timestamp, difficulty, generationHashProof, previousBlockHash, transactionsHash, receiptsHash, stateHash, beneficiaryAddress, feeMultiplier, totalSupply, feeTopay, inflation, collectedEpochFees, inflationMultiplier, transactions, }) {
        this.BLOCK_VERSION = 1;
        this.BLOCK_TYPE = 33091;
    ...
    serialize() {
        ...
        const blockHeaderReserved_1Bytes = Utils_1.Utils.uint32ToBuffer(0);
        newArray = Utils_1.Utils.concatTypedArrays(newArray, blockHeaderReserved_1Bytes);
...
exports.NormalBlock = NormalBlock;
//# sourceMappingURL=NormalBlock.js.map