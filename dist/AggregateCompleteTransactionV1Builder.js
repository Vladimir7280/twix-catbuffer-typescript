...
exports.AggregateCompleteTransactionV1Builder = void 0;
const AggregateTransactionBodyBuilder_1 = require("./AggregateTransactionBodyBuilder");
const GeneratorUtils_1 = require("./GeneratorUtils");
const TransactionBuilder_1 = require("./TransactionBuilder");
class AggregateCompleteTransactionV1Builder extends TransactionBuilder_1.TransactionBuilder {
    ...
    static loadFromBinary(payload) {
        ...
        return new AggregateCompleteTransactionV1Builder(superObject.signature, superObject.signerPublicKey, superObject.version, superObject.network, superObject.type, superObject.fee, superObject.deadline, aggregateTransactionBody.transactionsHash, aggregateTransactionBody.transactions, aggregateTransactionBody.cosignatures);
    }
    static createAggregateCompleteTransactionV1Builder(signature, signerPublicKey, version, network, type, fee, deadline, transactionsHash, transactions, cosignatures) {
        return new AggregateCompleteTransactionV1Builder(signature, signerPublicKey, version, network, type, fee, deadline, transactionsHash, transactions, cosignatures);
    }
    getTransactionsHash() {
...
exports.AggregateCompleteTransactionV1Builder = AggregateCompleteTransactionV1Builder;
//# sourceMappingURL=AggregateCompleteTransactionV1Builder.js.map