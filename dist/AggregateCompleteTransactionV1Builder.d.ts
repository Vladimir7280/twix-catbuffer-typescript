...
export declare class AggregateCompleteTransactionV1Builder extends TransactionBuilder implements Serializer {
    ...
    static loadFromBinary(payload: Uint8Array): AggregateCompleteTransactionV1Builder;
    static createAggregateCompleteTransactionV1Builder(signature: SignatureDto, signerPublicKey: PublicKeyDto, version: number, network: NetworkTypeDto, type: TransactionTypeDto, fee: AmountDto, deadline: TimestampDto, transactionsHash: Hash256Dto, transactions: EmbeddedTransactionBuilder[], cosignatures: CosignatureBuilder[]): AggregateCompleteTransactionV1Builder;
